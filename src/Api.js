...
export async function getUserData() {
    const url = "https://blog-api-g.adaptable.app/api/user-blog/";
...
export async function getPostDetails(id, isPublic) {
    ...
    const url = `https://blog-api-g.adaptable.app/${call}/post/${id}`;
    const data = await setupFetch(url, "get");
    return data;
}
...
export async function postComment(postID, formData, isPublic) {
    ...
    const url = `https://blog-api-g.adaptable.app/${call}/post/${postID}/comment`;
    const data = await setupFetch(url, "post", formData);
    return data;
}
